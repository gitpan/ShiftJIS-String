...
are legally coded in Shift_JIS.
...
B<MODIFIER>
  ...
  strtr("ğŒ‰‰Zq‚Ìg‚¢‚·‚¬‚ÍŒ©‹ê‚µ‚¢", '‚Ÿ-‚ñ', '”', 'cs');
    # output: ”‚Ì”‚¢‚·‚¬‚Í”‚µ‚¢
...
as you need not specify the parameter list every time.
  ...
  my $digit_tr = trclosure("1234567890-", "ˆê“ñOlŒÜ˜Zµ”ª‹ãZ|");
  print &$digit_tr ("TEL F0124-45-6789\n"); # ok to perl 5.003
  print $digit_tr->("FAX F0124-51-5368\n"); # perl 5.004 or better

  # output:
  # TEL FZˆê“ñl|lŒÜ|˜Zµ”ª‹ã
  # FAX FZˆê“ñl|ŒÜˆê|ŒÜO˜Z”ª
...
is counted as 1.
Similarly, the conversion between zenkaku hiragana C<'‚¤J'> and
zenkaku katakana C<'ƒ”'> is counted as 1.
